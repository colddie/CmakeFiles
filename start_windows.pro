...
;proc_dir = '\\uz\data\Admin\ngesoftware\kul_nm_software'
;proc_dir = 'C:\working\idl\kul_nm_software_development'
proc_dir = 'X:\storage0\home\tsun\code\kul_nm_software_development'
;path_init
...
!path = 'X:\storage0\home\tsun\code\idl\mgh' + delim + $   
        'X:\storage0\home\tsun\code\idl\transfer\MC' + delim + $
        'X:\storage0\home\tsun\code\idl\transfer\TUY' + delim + $
        'X:\storage0\home\tsun\code\idl\transfer\general' + delim + $
         'X:\storage0\home\tsun\code\idl\transfer\RECON' + delim + $
        'X:\storage0\home\tsun\code\idl\transfer\BHC' + delim + $   
        ;'X:\storage0\home\tsun\code\idl\transfer\example' + delim + $  
	    	'X:\storage0\home\tsun\code\idl\coyoteprograms\coyote' + delim + $
